<x-app-layout>
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            @forelse($criticalEvents->groupBy(function($event) {
                return $event->created_at->format('Y-m-d');
            }) as $date => $events)
                <div class="mb-8">
                    <h2 class="text-xl font-semibold mb-4 text-gray-700">{{ \Carbon\Carbon::parse($date)->format('Y. F j.') }}</h2>
                    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Időpont</th>
